...
class Jenis extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('v2/dashboard/jenis/view', $data);
    ...
    public function add()
    {
        ...
        $this->load->view('v2/dashboard/header', $data);
        $this->load->view('v2/dashboard/jenis/add', $data);
        $this->load->view('v2/dashboard/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('v2/dashboard/header', $data);
        $this->load->view('v2/dashboard/jenis/edit', $data);
        $this->load->view('v2/dashboard/footer');
    }
    ...
    public function save()
    {
        ...
        if ($save) {
            ...
            $result = [
                'status' => 'false',
                'messageType' => 'danger',
                'message' => 'Data jenis gagal disimpan.'
            ];
        }
        echo json_encode($result);
    }
