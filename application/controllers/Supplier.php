...
class Supplier extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('v2/dashboard/supplier/view', $data);
    ...
    public function add()
    {
        ...
        $this->load->view('v2/dashboard/header', $data);
        $this->load->view('v2/dashboard/supplier/add', $data);
        $this->load->view('v2/dashboard/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('v2/dashboard/header', $data);
        $this->load->view('v2/dashboard/supplier/edit', $data);
        $this->load->view('v2/dashboard/footer');
    }
    ...
    public function update($kode_kat)
    {
        ...
        $args = [
            'nama_supplier' => strtoupper($input['nama_supplier']),
            'alamat'        => strtoupper($input['alamat']),
            'no_tlp'        => $input['no_tlp']
        ];

        $update = $this->supplier_model->update($args, $kode_kat);
        if ($update) {
            $result = [
                'status' => 'true',
                'messageType' => 'success',
    ...
    {
        $deleted = $this->supplier_model->delete($kode_kat);
        if ($deleted) {
            $result = [
                'status' => 'true',
                'messageType' => 'success',
    ...
    public function save()
    {
        ...
        $save = $this->supplier_model->insert($args);
        if ($save) {
            $result = [
                'status' => 'true',
                'messageType' => 'success',
