...
class Laporan_model extends CI_Model
{
    public function getLaporanPenjualan($args)
    {
        ...
        return $this->db
                    ->select('DT.kode_brg, P.tanggal, B.nama_brg, sum(DT.qty) as qty, DT.harga_jual as harga_pokok, (sum(DT.qty)*DT.harga_jual) as total, (sum(DT.qty)*(DT.harga_jual-DT.harga_beli)) as laba')
