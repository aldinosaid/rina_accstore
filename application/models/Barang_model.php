...
class Barang_model extends CI_Model
{
    ...
    {
        return $this->db
                    ->select('B.id, B.kode_brg, B.nama_brg, S.kode_satuan, S.satuan, M.kode_merek, M.merek, J.kode_jenis, J.jenis, K.kode_kat, K.kategori, B.stok_toko, B.stok_gudang, B.harga_beli, B.harga_jual, B.grosir')
