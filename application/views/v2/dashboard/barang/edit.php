                              ...
                              <form class="form-horizontal" id="form_barang" action="<?php echo base_url('barang/update/'. $value->id ); ?>" method="POST">
                                 <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-10">
                                          <select class="form-control select2 auto_select" value="<?php echo $value->kode_jenis; ?>" name="kode_jenis" id="select-jenis">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-10">
                                          <select class="form-control select2 auto_select" value="<?php echo $value->kode_merek; ?>" name="kode_merek" id="select-merek">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-10">
                                          <select class="form-control select2 auto_select" value="<?php echo $value->kode_satuan; ?>" name="kode_satuan" id="select-satuan">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-10">
                                          <input type="text" name="qty" value="<?php echo $value->qty; ?>" class="form-control" id="qty">
                                       </div>
                                    </div>
                                    <div class="form-group row">
                                                            ...
                                                            <?php foreach ($value->grosir->min as $key_grosir => $value_grosir) : ?>
                                                                <div class="item-grosir row">
                                                                    <div class="col-md-5 col-sm-6 form-group row">
                                                                        ...
                                                                        <input type="text" class="col-md-5 form-control" name="grosir[min][]" value="<?php echo $value->grosir->min[$key_grosir]; ?>">
                                                                    </div>
                                                                    <div class="col-md-5 col-sm-6 form-group row">
                                                                        <label class="control-label">Harga Grosir</label>
                                                                            <input type="text" class="col-md-8 form-control harga" name="grosir[harga_jual_grosir][]" value="<?php echo $value->grosir->harga_jual_grosir[$key_grosir]; ?>">
                                                                    </div>
                                                                    <div class="col-md-2">
