         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="m-0">TAMBAH DATA JENIS BARU</h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
                     ...
                     <div class="col-lg-12">
                        <div class="card" id="card-jenis">
                           <div class="card-header">
                              <h3 class="card-title">ISI DATA JENIS</h3>
                           </div>
                           <div class="card-body">
                              <!-- form start -->
                              <form class="form-horizontal" id="form_jenis" action="<?php echo base_url('jenis/save'); ?>" method="POST">
                                 <div class="card-body">
