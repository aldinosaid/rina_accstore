...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">UBAH DATA REFERENSI</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="card" id="card-referensi">
                        <div class="card-header">
                            <h3 class="card-title">UBAH DATA REFERENSI</h3>
                        </div>
                        <div class="card-body">
                            <?php foreach($referensi as $value) : ?>
                            <!-- form start -->
                            <form class="form-horizontal" id="form_referensi" action="<?php echo base_url('referensi/update/'.$value->id_referensi); ?>" method="POST">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="nama_brg" class="col-sm-2 col-form-label">NAMA BARANG</label>
                                        <div class="col-sm-10">
                                            <select class="form-control select2 auto_select" name="kode_brg" id="select-barang" value="<?php echo $value->kode_brg; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control select2 auto_select" name="id_supplier" id="select-supplier" value="<?php echo $value->id_supplier; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="harga_supplier" class="form-control harga" value="<?php echo $value->harga_supplier; ?>" id="harga_supplier">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="qty" class="col-sm-2 col-form-label">QTY <small>{dalam satuan koli / bal}</small></label>
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $value->qty; ?>" name="qty" class="form-control" id="qty">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
