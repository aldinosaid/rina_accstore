         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="m-0">TAMBAH DATA MEREK BARU</h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
                     ...
                     <div class="col-lg-12">
                        <div class="card" id="card-merek">
                           <div class="card-header">
                              <h3 class="card-title">ISI DATA MEREK</h3>
                           </div>
                           <div class="card-body">
                              <!-- form start -->
                              <form class="form-horizontal" id="form_merek" action="<?php echo base_url('merek/save'); ?>" method="POST">
                                 <div class="card-body">
                                    <div class="form-group row">
                                       <label for="merek" class="col-sm-2 col-form-label">NAMA MEREK</label>
                                       <div class="col-sm-10">
                                          <input type="text" class="form-control" name="merek" id="merek" placeholder="NAMA MEREK">
                                       </div>
                                    </div>
                                 </div>
                                 <!-- /.card-body -->
