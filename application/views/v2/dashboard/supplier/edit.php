                     ...
                     <div class="col-lg-12">
                        <div class="card" id="card-supplier">
                           ...
                           <div class="card-body">
                              ...
                              <form class="form-horizontal" id="form_supplier" action="<?php echo base_url('supplier/update/'.$value->id_supplier); ?>" method="POST">
                                 <div class="card-body">
                                    <div class="form-group row">
                                       <label for="nama_supplier" class="col-sm-2 col-form-label">NAMA SUPPLIER</label>
                                       <div class="col-sm-10">
                                          <input type="text" class="form-control" name="nama_supplier" id="nama_supplier" value="<?php echo $value->nama_supplier; ?>" placeholder="NAMA SUPPLIER">
                                       </div>
                                    </div>
                                    <div class="form-group row">
