         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="m-0">TAMBAH DATA ADMIN PENGGUNA BARU</h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
                     ...
                     <div class="col-lg-12">
                        <div class="card" id="card-admin_login">
                           <div class="card-header">
                              <h3 class="card-title">ISI DATA ADMIN PENGGUNA</h3>
                           </div>
                           <div class="card-body">
                              <!-- form start -->
                              <form class="form-horizontal" id="form_admin_login" action="<?php echo base_url('admin_login/save'); ?>" method="POST">
                                 <div class="card-body">
                                    <div class="form-group row">
                                       <label for="name" class="col-sm-4 col-form-label">NAMA ADMIN PENGGUNA</label>
                                       <div class="col-sm-8">
                                          <input type="text" class="form-control" name="name" id="name" placeholder="NAMA ADMIN PENGGUNA">
                                       </div>
                                    </div>
                                    <div class="form-group row">
